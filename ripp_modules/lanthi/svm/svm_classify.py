...
input_training_file = 'ripp_modules/lanthi/svm/lanthi_training_set.csv'         # the CSV containing the training set
input_fitting_file = 'ripp_modules/lanthi/svm/fitting_set.csv'         # the CSV containing the data to be fitted
output_filename = 'ripp_modules/lanthi/svm/fitting_results.csv'     # output filename; this will be a CSV with the first column being the primary key and the second being the classification
